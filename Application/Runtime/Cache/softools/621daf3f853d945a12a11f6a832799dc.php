...
<head>
    ...
    <script>
        $(function () {
            ...
            $.get('/Subscribe/test_bos', {keywords: _key,type: _type,levname: _levname,typename: _typename}).done(function (result) {
...
//                                        },
//                                        symbol: 'circle',
//                                        markLine: result['data'][0]['markLine'],
//                                        label: {
//                                            normal: {
//                                                show: true,
//                                                formatter: function (param) {
